...
"shroud": [
 ...
 ("adapt","Dark Adaptation","See 22 further per rank without emitting a thing.",
  [eff("vision",22.0)],8,110,0.0,1),
 ...
 ("nightsight","Night Sight","See 34 further per rank without emitting a thing.",
  [eff("vision",34.0)],8,620,0.0,2),
 ...
 ("pupil","Wide Pupil","See 48 further per rank without emitting a thing.",
  [eff("vision",48.0)],8,2100,0.0,3),
 ("occlude","Occlusion","Luminance reduced 4.5% per rank.",[eff("shroud",0.045)],10,3400,0.0,4),
 ("hush","Hush","Light reduced 0.4%. No cap.",[eff("shroud",0.004)],-1,320,0.0,2),
 ("peer","Peer","See 3 further. No cap.",[eff("vision",3.0)],-1,380,0.0,2),
...
KEYSTONES = [
 ...
 ("shroud_cinder","shroud","Cinder",
  "Below 20 light nothing spawns at all. Above it, spawn rate doubles.",
