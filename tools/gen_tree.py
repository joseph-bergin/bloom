...
"root": [
 ...
 ("bank","Bank","+10% embers banked per rank.",[eff("ember_mult",0.10,"mul")],6,600,2.4,1),
 ...
 ("deepbank","Deep Bank","+12% embers banked per rank.",
  [eff("ember_mult",0.12,"mul")],6,2400,2.6,3),
...
EMBER = [
 ...
 ("ember_4", [
   ...
   ("richer","Richer","+1% mote yield. No cap.",[eff("mote_mult",0.01,"mul")],-1,7,0.1),
